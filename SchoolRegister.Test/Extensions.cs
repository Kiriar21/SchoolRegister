    ...
    public static class Extensions
    {
        ...
        public static async void SeedData(this IServiceCollection services)
        {
            ...
            var t1 = new Teacher()
            {
                ...
                Title = "mgr inż.",
                RegistrationTime = new DateTime(2010, 1, 1),
            };
            ...
            var t2 = new Teacher()
            {
                ...
                Email = "t2@eg.eg",
                Title = "mgr",
                RegistrationTime = new DateTime(2010, 11, 12),
            };
            ...
            var p1 = new Parent()
            {
                ...
                UserName = "p1@eg.eg",
                Email = "real_email@eg.eg",
                RegistrationTime = new DateTime(2014, 03, 20),
            };
            ...
            var p2 = new Parent()
            {
                ...
                UserName = "p2@eg.eg",
                Email = "p2@eg.eg",
                RegistrationTime = new DateTime(2014, 06, 21),
            };
            ...
            var s1 = new Student()
            {
                ...
                UserName = "s1@eg.eg",
                Email = "s1@eg.eg",
                RegistrationTime = new DateTime(2016, 05, 11),
                GroupId = 1,
                ParentId = 3
            };
            ...
            var s2 = new Student()
            {
                ...
                UserName = "s2@eg.eg",
                Email = "s2@eg.eg",
                RegistrationTime = new DateTime(2015, 09, 18),
                GroupId = 1,
                ParentId = 3
            };
            ...
            var s3 = new Student()
            {
                ...
                UserName = "s3@eg.eg",
                Email = "s3@eg.eg",
                RegistrationTime = new DateTime(2017, 07, 16),
                GroupId = 2,
                ParentId = 3
            };
            ...
            var s4 = new Student()
            {
                ...
                UserName = "s4@eg.eg",
                Email = "s4@eg.eg",
                RegistrationTime = new DateTime(2018, 05, 14),
                GroupId = 2,
                ParentId = 4
            };
            ...
            var s5 = new Student()
            {
                ...
                UserName = "s5@eg.eg",
                Email = "s5@eg.eg",
                RegistrationTime = new DateTime(2019, 02, 19),
                GroupId = 3,
                ParentId = 4
            };
            ...
            var s6 = new Student()
            {
                ...
                UserName = "s6@eg.eg",
                Email = "s6@eg.eg",
                RegistrationTime = new DateTime(2019, 05, 1),
                GroupId = 3,
                ParentId = 4
            };
            ...
            var a1 = new User()
            {
                ...
                UserName = "a1@eg.eg",
                Email = "a1@eg.eg",
                RegistrationTime = new DateTime(2009, 1, 1)
            };
