...
INSERT [dbo].[Groups] ([GroupId], [Name]) VALUES (1, N'IO')
INSERT [dbo].[Groups] ([GroupId], [Name]) VALUES (2, N'PAI') 
INSERT [dbo].[Groups] ([GroupId], [Name]) VALUES (3, N'AIP_Erasmus+') 
...
INSERT [dbo].[Subjects] ([SubjectId], [Name], [Description], [TeacherId]) VALUES (1, N'Aplikacje WWW', N'Aplikacje webowe', 1) 
INSERT [dbo].[Subjects] ([SubjectId], [Name], [Description], [TeacherId]) VALUES (2, N'Programowanie obiektowe', N'Programowanie obiektowe jest przedmiotem realizującym przykłady programowanie obiektowego', 1) 
INSERT [dbo].[Subjects] ([SubjectId], [Name], [Description], [TeacherId]) VALUES (3, N'Advanced Internet Programming', N'Advanced Internet Programming is a course for ERASMUS+ students', 2) 
INSERT [dbo].[Subjects] ([SubjectId], [Name], [Description], [TeacherId]) VALUES (4, N'Administracja Intenetowymi Systemami Baz Danych', N'Administracja Intenetowymi Systemami Baz Danych jest kontynuacją przedmiotu Bazy danych na studiach stacjonarnych I-go stopnia spec. PAI', 2)
